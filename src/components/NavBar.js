...
const NavBar = () => {
  ...
  return (
    <header className="w-full px-32 py-8  z-10 font-medium flex items-center justify-between dark:text-light relative lg:px-16 md:px-12 sm:px-8">
      <button
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex items-center  justify-center flex-wrap-rev ">
          <motion.a
            href="https://github.com/femorales7"
            target={"_blank"}
            whileHover={{ y: -2 }}
            className="w-6 mr-3"
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            href="https://www.linkedin.com/in/fabian-morales-782b02145"
            target={"_blank"}
            whileHover={{ y: -2 }}
            className="w-6 mr-3"
            whileTap={{ scale: 0.9 }}
      ...
      {isOpen ? (
        ...
        bg-dark/95 dark:bg-light/90 rounded-lg backdrop:-blur-md py-32 "
        >
          ...
          <nav className="flex items-center  justify-center flex-wrap-rev  mt-2">
            <motion.a
              href="https://github.com/femorales7"
              target={"_blank"}
              whileHover={{ y: -2 }}
      ...
      <div className="absolute left-[50%] top-2  traslate-x-[-50%]">
        ...
        <Logo mode={mode} className="pt-8 xs:pt-0"/>
      </div>
    </header>
  );
};
